...
var DateTimePicker = function (_Events) {
  ...
  createClass(DateTimePicker, [{
    ...
    key: 'open',
    value: function open(title, mode) {
    ...
    value: function clickShowCalendar() {
      if ($('.c-datepicker__calendar:visible').length) {
        return;
      }
      $(".c-datepicker").addClass('flipped');
      var instance = this;
      setTimeout(function(){
        instance.$('.js-show-calendar').classList.add('is-selected');
        instance.$('.js-show-clock').classList.remove('is-selected');
      }, 300);
      setTimeout(function(){
        $(".c-datepicker").removeClass('flipped');
      }, 600);
    ...
    value: function clickShowClock() {
      if ($('.c-datepicker__clock:visible').length) {
        return;
      }
      $(".c-datepicker").addClass('flipped');
      var instance = this;
      setTimeout(function(){
        instance.$('.js-show-calendar').classList.remove('is-selected');
        instance.$('.js-show-clock').classList.add('is-selected');
      }, 300);
      setTimeout(function(){
        $(".c-datepicker").removeClass('flipped');
      }, 600);
